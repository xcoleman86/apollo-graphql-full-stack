...
$root.Trace = (function() {
     ...
     * @property {string|null} [clientId] Trace clientId
    ...
    Trace.encode = function encode(message, writer) {
        ...
        if (message.clientId != null && message.hasOwnProperty("clientId"))
            writer.uint32(/* id 23, wireType 2 =*/186).string(message.clientId);
        return writer;
    };
...
$root.StatsContext = (function() {
     ...
     * @property {string|null} [clientId] StatsContext clientId
    ...
    /**
     * StatsContext clientId.
     * @member {string} clientId
     * @memberof StatsContext
     * @instance
     */
    StatsContext.prototype.clientId = "";
