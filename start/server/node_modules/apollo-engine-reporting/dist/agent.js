...
class EngineReportingAgent {
    constructor(options = {}, { schemaHash }) {
        ...
        this.reportHeader = new apollo_engine_reporting_protobuf_1.ReportHeader(Object.assign({}, serviceHeaderDefaults, { schemaHash, schemaTag: options.schemaBranch || process.env.ENGINE_SCHEMA_BRANCH || '' }));
        this.resetReport();
