(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('symbol-observable'), require('apollo-link'), require('apollo-link-dedup'), require('graphql/language/printer'), require('graphql'), require('graphql-anywhere'), require('apollo-utilities')) :
    typeof define === 'function' && define.amd ? define(['exports', 'symbol-observable', 'apollo-link', 'apollo-link-dedup', 'graphql/language/printer', 'graphql', 'graphql-anywhere', 'apollo-utilities'], factory) :
    (factory((global.apollo = global.apollo || {}, global.apollo.core = {}),global.$$observable,global.apolloLink.core,global.apolloLink.dedup,global.print,global.graphql,global.graphqlAnywhere,global.apollo.utilities));
}(this, (function (exports,$$observable,apolloLink,apolloLinkDedup,printer,graphql,graphql$1,apolloUtilities) { 'use strict';

    $$observable = $$observable && $$observable.hasOwnProperty('default') ? $$observable['default'] : $$observable;
    graphql$1 = graphql$1 && graphql$1.hasOwnProperty('default') ? graphql$1['default'] : graphql$1;
    ...
    var LocalState = (function () {
        ...
        LocalState.prototype.runResolvers = function (_a) {
            ...
            if (query) {
                ...
                if (resolver) {
                    ...
                    rootValue = rootValue
                        ? apolloUtilities.mergeDeep(rootValue, remoteResult)
                        : remoteResult;
                    try {
                        localResult = graphql$1(resolver, query, rootValue, context, variables, { fragmentMatcher: this.fragmentMatcher });
                    }
                    catch (error) {
                        if (onError) {
                            onError(error);
            ...
            return __assign$3({}, remoteResult, localResult);
        };
        ...
        LocalState.prototype.prepareContext = function (context) {
            ...
            var newContext = __assign$3({}, context, { cache: cache, getCacheKey: function (obj) {
                    if (cache.config) {
        ...
        LocalState.prototype.addExportedVariables = function (document, variables, context) {
            ...
            if (document &&
                apolloUtilities.hasDirectives(['client'], document) &&
                apolloUtilities.hasDirectives(['export'], document)) {
                ...
                if (preparedResolver.resolver) {
                    ...
                    graphql$1(preparedResolver.resolver, document, rootValue || {}, updatedContext, variables);
                    exportedVariables = preparedResolver.exportedVariables;
                }
            }
            return __assign$3({}, variables, exportedVariables);
        };
        ...
        LocalState.prototype.mergeInitializers = function (initializers) {
            ...
            if (Array.isArray(initializers)) {
                initializers.forEach(function (initializerGroup) {
                    mergedInitializers = __assign$3({}, mergedInitializers, initializerGroup);
                });
            }
            else {
        ...
        LocalState.prototype.prepareResolver = function (query) {
            ...
            resolver = function (fieldName, rootValue, args, context, info) {
                ...
                var updatedContext = __assign$3({}, context, { cache: cache,
                    client: client });
                var result;
        ...
        LocalState.prototype.buildRootValueFromCache = function (document, variables) {
            var query = apolloUtilities.buildQueryFromSelectionSet(document);
        ...
        LocalState.prototype.removeClientSetsFromDocument = function (query) {
            ...
            var docClone = apolloUtilities.removeDirectivesFromDocument([
                {
    ...
    var QueryManager = (function () {
        ...
        QueryManager.prototype.mutate = function (_a) {
            ...
            return new Promise(function (resolve, reject) {
                var storeResult;
                var error;
                var operation = _this.buildOperationForLink(mutation, updatedVariables, __assign$4({}, context, { optimisticResponse: optimisticResponse }));
        ...
        QueryManager.prototype.fetchQuery = function (queryId, options, fetchType, fetchMoreForQueryId) {
            ...
            var updatedOptions = __assign$4({}, options, { variables: updatedVariables });
            var storeResult;
        ...
        QueryManager.prototype.fetchRequest = function (_a) {
            ...
            return new Promise(function (resolve, reject) {
                ...
                if (serverQuery) {
                    var operation = _this.buildOperationForLink(serverQuery, variables, __assign$4({}, context, { forceFetch: !_this.queryDeduplication }));
        ...
        QueryManager.prototype.prepareContext = function (context) {
            ...
            return __assign$4({}, newContext, { clientAwareness: this.clientAwareness });
        };
        return QueryManager;
    }());
